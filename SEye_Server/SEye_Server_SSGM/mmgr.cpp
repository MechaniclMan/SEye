...
static char *memoryLogFile					= "memory_scripts.log";
static const char *memoryLeakLogFile		= "memleak_scripts%d.log";
#elif SHADERS_EXPORTS
static char	*memoryLogFile					= "memory_shaders.log";
static const char *memoryLeakLogFile		= "memleak_shaders%d.log";
#elif  BHS_EXPORTS
static char	*memoryLogFile					= "memory_bhs.log";
static const char *memoryLeakLogFile		= "memleak_bhs%d.log";
#elif  SDBEDIT
static char *memoryLogFile					= "memory_sdbedit.log";
static const char *memoryLeakLogFile		= "memleak_sdbedit%d.log";
#elif PROXYDLL_EXPORTS
static char *memoryLogFile					= "memory_d3d8.log";
static const char *memoryLeakLogFile		= "memleak_d3d8%d.log";
#else
static char *memoryLogFile					= "memory_unknown.log";
static const char *memoryLeakLogFile		= "memleak_unknown%d.log";
#endif
