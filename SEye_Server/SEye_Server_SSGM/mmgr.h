...
#define	malloc(sz)	m_allocator  (__FILE__,__LINE__,"",m_alloc_malloc,sz)
#define	calloc(sz)	m_allocator  (__FILE__,__LINE__,"",m_alloc_calloc,sz)
#define	realloc(ptr,sz)	m_reallocator(__FILE__,__LINE__,"",m_alloc_realloc,sz,ptr)
#define	free(ptr)	m_deallocator(__FILE__,__LINE__,"",m_alloc_free,ptr)
